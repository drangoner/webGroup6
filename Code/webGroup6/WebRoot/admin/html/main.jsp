    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-header">
            <div class="ht-console">
                <div class="ht-user">
                    <a class="ht-user-name" style="margin-left:0px;">超级管理员:<%=session.getAttribute("name") %></a>
                </div>
            </div>
            <span class="sys-title">通讯录后台管理系统</span>
            <ul class="ht-nav">
                <li class="ht-nav-item">
                    <a target="_blank" href="../../student/sign-in.html">前台入口</a>
                </li>
                <li class="ht-nav-item">
                    <a href="javascript:;" id="individuation"><i class="fa fa-tasks fa-fw" style="padding-right:5px;"></i>个性化</a>
                </li>
                <li class="ht-nav-item">
                    <a href="../../servlet/LogoutServlet"><i class="fa fa-power-off fa-fw"></i>注销</a>
                </li>
            </ul>
        </div>
        <!--侧边导航-->
                    ...
                    <li class="layui-nav-item layui-this">
                     ...
                     <li class="layui-nav-item">
                        ...
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="userlist.jsp" data-id="4">全部用户</a></dd>
                            <dd><a href="javascript:;" data-url="blackuserlist.jsp" data-id="5">黑名单管理</a></dd>
                        </dl>
                    </li>
                    <li class="layui-nav-item">
                        <a href="javascript:;"><i class="fa fa-file-text"></i>内容管理</a>
                        <dl class="layui-nav-child">
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="1">电话管理</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="2">班级管理</a></dd>
                            <dd><a href="javascript:;" data-url="datalist.html" data-id="3">回收站</a></dd>
                    </li>
                ...
                <div class="layui-tab-content">
                    <div class="layui-tab-item layui-show">
                        <p style="padding: 10px 15px; margin-bottom: 20px; margin-top: 10px; border:1px solid #ddd;display:inline-block;">
                            ...
                            <span style="padding-left:1em;">地点：江西南昌</span>
                            <span style="padding-left:1em;">时间：<%=session.getAttribute("lastlogin") %></span>
                        </p>
                            ...
                            <div class="layui-field-box">
                                <div style="display: inline-block; width: 100%;">
                                    <div class="ht-box layui-bg-blue">
                                        <p><%=session.getAttribute("usernum") %></p>
                                        <p>用户总数</p>
                                    </div>
        ...
        <div class="layui-footer">
            <p style="line-height:44px;text-align:center;">通讯录后台管理系统</p>
        </div>
        <!--快捷菜单-->
