...
layui.define(['laypage', 'layer', 'form', 'pagesize'], function (exports) {
    ...
    function loadData(){
    	...
    	xmlhttp.open("GET","../../servlet/StuListServlet?isvalid="+isvalid,true);
    	xmlhttp.send();
    ...
    //详细信息
    function detail(sid){
    	window.location.href="./detail.jsp?sid="+sid;
    }
    
    //拉入黑名单
    function gotoBlack(sid){
        window.location.href="../../servlet/StuSetValid?sid="+sid+"&valid=0";
    }
    
    function removeBlack(sid){
        window.location.href="../../servlet/StuSetValid?sid="+sid+"&valid=1";
    }
    //添加数据
